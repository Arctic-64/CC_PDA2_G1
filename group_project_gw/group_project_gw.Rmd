...
Selecting data columns of interest, then filtering to (i) include quarters from 2020-2021 inclusive only and (ii) to exclude the aggregates S92000003 "Scotland" and "All Inpatients and Day cases", and the SN0811 "National Facility NHS Louisa Jordan" as only 2021Q1 data also as located within Urban Glasgow and contains NAs, then column renaming:
...
```{r}
hb_name_convert <- tibble(hb_code = c("SB0801", "S08000015", "S08000016", "S08000017", "S08000018", "S08000019", "S08000020", "S08000021", "S08000022", "S08000023", "S08000024", "S08000025", "S08000026", "S08000027", "S08000028", "S08000029", "S08000030", "S08000031", "S08000032", "S27000001"), hb_name = c("The Golden Jubilee National Hospital", "Ayrshire and Arran", "Borders", "Dumfries and Galloway", "Fife", "Forth Valley", "Grampian", "Greater Glasgow and Clyde", "Highland", "Lanarkshire", "Lothian", "Orkney", "Shetland", "Tayside", "Western Isles", "Fife", "Tayside", "Greater Glasgow and Clyde", "Lanarkshire",  "Non-NHS Provider Location"))
...
```{r}
urban <- c("Forth Valley", "Greater Glasgow and Clyde", "Lanarkshire", "Lothian", "Fife", "Tayside", "Greater Glasgow and Clyde", "Lanarkshire", "The Golden Jubilee National Hospital", "Non-NHS Provider Location")
