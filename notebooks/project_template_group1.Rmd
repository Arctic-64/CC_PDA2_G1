...
**Grant Walker** set up the Trello project management tool, and worked on the `National Variation` dashboard tab (workpack 2).
...
We prioritised the delivery of a minimum viable product (MVP) consisting of 3 dashboard tabs and outlined what the extension scope would be if time permitted working on this. 
...
- We used the activity by hearth boards and speciality, and demographics information to answer the variation in hospital activity across the country (Grant).
